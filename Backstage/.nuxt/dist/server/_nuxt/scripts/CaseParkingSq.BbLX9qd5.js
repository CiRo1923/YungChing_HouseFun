  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "caseParkingSq",
        modelValue: unref(pingData).caseParkingSq,
        "onUpdate:modelValue": ($event) => unref(pingData).caseParkingSq = $event,
        config: {
          inputMode: "numeric",
          inputChinese: false,
          checkNotIsZero: true
        ...
        onBlur: ($event) => unref(basic).onPinSqMetersConvert("caseParkingSq")
      }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/buy/_components/basic/Ping/CaseParkingSq.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=CaseParkingSq.BbLX9qd5.js.map
