  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        modelValue: unref(apiData).casePurposeToken,
        "onUpdate:modelValue": ($event) => unref(apiData).casePurposeToken = $event,
        options: unref(options).casePurpose,
        config: {
          schema: {
            label: "text",
            value: "code"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/buy/_components/basic/Info/CasePurpose.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=CasePurpose.BA7miFL8.js.map
