  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        name: "caseFaceToken",
        modelValue: unref(apiData).caseFaceToken,
        "onUpdate:modelValue": ($event) => unref(apiData).caseFaceToken = $event,
        options: unref(options).face,
        config: {
          placeholder: {
            value: "請選擇朝向",
            isToOption: true
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/buy/_components/basic/Info/Face.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=Face.tGYHUew8.js.map
