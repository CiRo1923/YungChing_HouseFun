  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        name: "caseManageDutyToken",
        modelValue: unref(apiData).caseManageDutyToken,
        "onUpdate:modelValue": ($event) => unref(apiData).caseManageDutyToken = $event,
        options: unref(options).manageDuty,
        config: {
          placeholder: {
            value: "請選擇管理時段",
            isToOption: true
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/buy/_components/basic/Manage/CaseManageDuty.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=CaseManageDuty.8pbPdxxm.js.map
