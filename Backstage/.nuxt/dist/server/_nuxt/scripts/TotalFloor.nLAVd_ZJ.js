  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        name: "caseFloorTotal",
        modelValue: unref(apiData).caseFloorTotal,
        "onUpdate:modelValue": ($event) => unref(apiData).caseFloorTotal = $event,
        config: {
          isExistClose: false
        },
        rules: {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/buy/_components/basic/Info/TotalFloor.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=TotalFloor.nLAVd_ZJ.js.map
