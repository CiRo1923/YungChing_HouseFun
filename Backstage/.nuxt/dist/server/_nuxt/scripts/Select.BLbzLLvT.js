...
import { d as deepMerge, b as deepClone, e as emptyData } from "./_prototype.DwbhdnQa.js";
const borderWidth = 0;
const _sfc_main = {
  __name: "Select",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (isActive.value && options.value && options.value.length !== 0 && !config.value.isDisabled) {
          _push2(`<div class="${ssrRenderClass([setClass.value.dropdown, "m-select-dropdown absolute z-[5] mt-[3px] overflow-hidden"])}"><ul class="${ssrRenderClass([setClass.value.dropdownContainer, "m-select-dropdown-container max-h-full bg-[#fff]"])}"><!--[-->`);
...
//# sourceMappingURL=Select.BLbzLLvT.js.map
