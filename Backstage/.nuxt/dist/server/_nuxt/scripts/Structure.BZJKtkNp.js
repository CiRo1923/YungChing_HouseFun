  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        modelValue: unref(apiData).caseStructureToken,
        "onUpdate:modelValue": ($event) => unref(apiData).caseStructureToken = $event,
        options: unref(options).structure,
        config: {
          placeholder: {
            value: "請選擇建物結構",
            isToOption: true
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/buy/_components/basic/Info/Structure.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=Structure.BZJKtkNp.js.map
