...
import { _ as _sfc_main$1 } from "./Input.DngVdA-a.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        name: "caseLandNo",
        modelValue: unref(apiData).caseLandNo,
        "onUpdate:modelValue": ($event) => unref(apiData).caseLandNo = $event,
        config: {
          placeholder: "請輸入地號"
        },
        rules: {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/buy/_components/basic/Info/CaseLandNo.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=CaseLandNo.j6gGwBdP.js.map
