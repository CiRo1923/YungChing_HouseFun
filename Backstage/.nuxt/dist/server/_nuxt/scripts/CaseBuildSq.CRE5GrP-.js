  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "caseBuildSq",
        modelValue: unref(pingData).caseBuildSq,
        "onUpdate:modelValue": ($event) => unref(pingData).caseBuildSq = $event,
        config: {
          inputMode: "numeric",
          inputChinese: false,
          checkNotIsZero: true
        ...
        onBlur: ($event) => unref(basic).onPinSqMetersConvert("caseBuildSq")
      }, {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        modelValue: unref(apiData).isCaseBuildSqIncludeParking,
        "onUpdate:modelValue": ($event) => unref(apiData).isCaseBuildSqIncludeParking = $event,
        config: {
          label: "含車位",
          value: {
            true: true,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/buy/_components/basic/Ping/CaseBuildSq.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=CaseBuildSq.CRE5GrP-.js.map
