  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        name: "caseUsageToken",
        modelValue: unref(apiData).caseUsageToken,
        "onUpdate:modelValue": ($event) => unref(apiData).caseUsageToken = $event,
        options: unref(options).caseUsage,
        config: {
          placeholder: "請選擇法定用途",
          schema: {
            label: "text",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/buy/_components/basic/Info/CaseUsage.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=CaseUsage.Cj1r67ev.js.map
