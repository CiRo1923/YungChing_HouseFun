...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/buy/_containers/RadiosOval.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const RadiosOval = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  RadiosOval as default
};
//# sourceMappingURL=RadiosOval.NzLPxeP9.js.map
