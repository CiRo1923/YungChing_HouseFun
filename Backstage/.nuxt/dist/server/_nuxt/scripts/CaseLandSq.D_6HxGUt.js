  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        name: "caseLandSq",
        modelValue: unref(pingData).caseLandSq,
        "onUpdate:modelValue": ($event) => unref(pingData).caseLandSq = $event,
        config: {
          inputMode: "numeric",
          inputChinese: false,
          checkNotIsZero: true
        ...
        onBlur: ($event) => unref(basic).onPinSqMetersConvert("caseLandSq")
      }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/buy/_components/basic/Ping/CaseLandSq.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=CaseLandSq.D_6HxGUt.js.map
