...
import { $fetch as $fetch$1 } from "F:/Git/YungChing/Dev/HouseFun/Backstage/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "F:/Git/YungChing/Dev/HouseFun/Backstage/node_modules/nuxt/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "F:/Git/YungChing/Dev/HouseFun/Backstage/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "F:/Git/YungChing/Dev/HouseFun/Backstage/node_modules/h3/dist/index.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu } from "F:/Git/YungChing/Dev/HouseFun/Backstage/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "F:/Git/YungChing/Dev/HouseFun/Backstage/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "error",
    path: "/error",
    component: () => import("./_nuxt/scripts/error.93a5M688.js")
  },
  {
    name: "buy-basic",
    path: "/buy/basic",
  ...
  },
  {
    name: "home",
    path: "/home",
    component: () => import("./_nuxt/scripts/index.CXbEJMlV.js")
  },
  {
    name: "buy-parking",
    path: "/buy/parking",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/scripts/parking.Ctypfich.js")
  },
  {
    name: "buy-_containers-BackStep",
    path: "/buy/_containers/BackStep",
    component: () => import("./_nuxt/scripts/BackStep.v3H_dQo9.js")
  },
  {
    name: "buy-_containers-CardFilter",
    path: "/buy/_containers/CardFilter",
    component: () => import("./_nuxt/scripts/CardFilter.DVAJog-e.js")
  },
  {
    name: "buy-_containers-RadiosOval",
    path: "/buy/_containers/RadiosOval",
    component: () => import("./_nuxt/scripts/RadiosOval.NzLPxeP9.js")
  },
  {
  ...
  },
  {
    ...
    path: "/buy/_components/basic/BackStep",
    component: () => import("./_nuxt/scripts/BackStep.BeND9Tno.js")
  },
  {
...
const layouts = {
  buy: defineAsyncComponent(() => import("./_nuxt/scripts/buy.BO-eHsYT.js").then((m) => m.default || m)),
  rent: defineAsyncComponent(() => import("./_nuxt/scripts/rent.BF65_P4L.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/scripts/error-404.ViZa-zbn.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/scripts/error-500.BadNlzG-.js"));
