 ...
 */
export const SOURCE_PROJECT_NAME = 'Royal Canin'
 ...
 * 有沒有那一類,不必在這裡宣告。本專案的 fontFamily 沒有被整組覆寫,
 * 所以 font-sans / font-serif / font-mono 正常可用,不列在這裡。
 */
 ...
 * 多數專案不需要這一項,留空陣列即可。
 */
export const PLAIN_TEXT_EXCLUDED_DIRS = []
