...
export const apiPostMemberAuthPasswordResetRequest = async (data) =>
  await fetchApi.post(`member/auth/password-reset/request`, data)

// mobilePhone + verificationCode + resetToken + newPassword + confirmPassword
// → success / requireRelogin / message
export const apiPostMemberAuthPasswordResetConfirm = async (data) =>
  await fetchApi.post(`member/auth/password-reset/confirm`, data)
