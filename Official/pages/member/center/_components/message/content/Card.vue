  ...
  >
    ...
    <div class="min-w-0 grow m:contents pt:space-y-[5px]">
      ...
      <div class="min-w-0 flex-1 pt:space-y-[5px]">
        <PageMemberCenterMessageContentCardTitle :item="props.item" />
        <PageMemberCenterMessageContentCardAddressInfo :item="props.item" />
        <PageMemberCenterMessageContentCardBasicInfo :item="props.item" />
      </div>
      <div class="m:flex m:w-full m:flex-col-reverse pt:space-y-[5px]">
        <PageMemberCenterMessageContentCardTimeInfo :item="props.item" />
        <PageMemberCenterMessageContentCardBrokerInfo :item="props.item" />
      </div>
    </div>
